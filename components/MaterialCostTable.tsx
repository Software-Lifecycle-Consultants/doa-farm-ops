...
import { MaterialCostSchema } from '@/schemas/cost.schema';
import { validateFormData } from '@/utils/validation';
import { toast } from 'react-toastify';
import { ZodErrors } from './ZodErrors';
import { LabourCost } from '@/redux/types';
...
export default function MaterialCostTable({cropId}: MaterialCostTableProps) {
  ...
  const [validationErrors, setValidationErrors] = useState<Partial<MaterialCostTable>>({});
          ...
          >
            ...
            >
              ...
              {validationErrors.material && (
                <ZodErrors error={[validationErrors.material]} />
              )}
            </FormControl>
            <FormControl
              variant="standard"
            ...
            >
              ...
              />
              {validationErrors.qtyUsed && (
                <ZodErrors error={[validationErrors.qtyUsed]} />
              )}
            </FormControl>
            <FormControl
              variant="standard"
            ...
            >
              ...
              {validationErrors.materialCost && (
                <ZodErrors error={[validationErrors.materialCost]} />
              )}
            </FormControl>
            <FormControl
              variant="standard"
